...
/* @Static */
{
    ...
    findAll : function(params, success, error) {
        return $.ajax({
            url: location.href.match(/multimedia\.tlsur\.net/) ? '/api/categoria' : 'http://multimedia.tlsur.net/api/categoria/',
            dataType: location.href.match(/multimedia\.tlsur\.net/) ? 'json' : 'jsonp categoria.models',
            data: params,
            success: success,
